...
class DokumenPribadiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'customFile1' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'customFile2' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'customFile3' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'customFile4' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'customFile5' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'customFile6' => 'required|image|mimes:jpeg,png,jpg|max:20000',
            'Pernyataan' => 'accepted',
        ]);
    ...
    public function status(Request $request, $id)
    {
        ...
        return redirect()->route('adminsitrasi.pribadi')->with('success', 'Status administrasi berhasil diperbaharui');
    }
}
